...
const translations = {
    en: {
        ...
        'intro.subtitle': '– and help others do the same!',
        // Why Signal page
        ...
        'whySignal.benefit1': 'Signal is a foundation without shareholders or venture capitalists and is funded by donations instead of ads.',
        'whySignal.benefit2Title': 'Privacy by design',
        'whySignal.benefit2': 'Signal collects no user data and offers the highest level of privacy. Even WhatsApp and Facebook Messenger use Signal’s encryption protocol.',
        'whySignal.benefit3Title': 'Ethical leadership',
        'whySignal.benefit3': 'CEO Meredith Whittaker champions ethical tech and fights Big Tech surveillance.',
        'whySignal.benefit4Title': 'Independent infrastructure',
        'whySignal.benefit4': 'Signal protects users worldwide without compromising privacy or usability.',
        'whySignal.openSourceTitle': 'Open Source and Transparency',
        'whySignal.openSourceText': 'Signal is open-source, giving everyone the chance to review the code and verify there are no backdoors – building transparency and trust.',
    ...
    nl: {
        ...
        'intro.subtitle': '– en help anderen hetzelfde te doen!',
        // Why Signal page
        ...
        'whySignal.benefit1': 'Signal is een stichting zonder aandeelhouders of durfkapitalisten en wordt gefinancierd door donaties in plaats van advertenties.',
        'whySignal.benefit2Title': 'Privacy als kern',
        'whySignal.benefit2': 'Signal verzamelt geen gebruikersdata en biedt maximale privacybescherming. Zelfs WhatsApp en Facebook Messenger gebruiken Signals encryptieprotocol.',
        'whySignal.benefit3Title': 'Ethisch leiderschap',
        'whySignal.benefit3': 'CEO Meredith Whittaker benadrukt ethische technologie en strijdt tegen het surveillancemodel van Big Tech.',
        'whySignal.benefit4Title': 'Onafhankelijke infrastructuur',
        'whySignal.benefit4': 'Signal beschermt gebruikers wereldwijd zonder concessies aan privacy of gebruiksgemak.',
        'whySignal.openSourceTitle': 'Open Source en Transparantie',
        'whySignal.openSourceText': 'Signal is open-source, zodat iedereen de code kan controleren en zeker weet dat er geen achterdeuren zijn – dit bevordert transparantie en vertrouwen.',
        ...
        'howItWorks.step1': '1. 📸 Upload je profielfoto',
        'howItWorks.step2': '2. 🖼️ Voeg de badge toe',
